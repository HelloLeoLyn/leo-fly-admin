<template>
  <div style="padding: 0 20px; background-color: silver">
    <el-button type="primary" size="default"
      @click="handBltClk(apiOptions.getSchema)">{{ apiOptions.getSchema.desc }}</el-button>
    <el-form :model="formValues" ref="formValues" :rules="rules" label-width="180px" :inline="false"
      size="normal">
        ...
        <el-form-item :key="layoutName" v-if="schema.hierarchy.structure[layoutName]"
          ...
          <template v-for="layoutName2 in schema.hierarchy.structure[layoutName]">
            <el-form-item :key="layoutName2" :label="schema.data[layoutName2].fields.label"
              ...
              ></el-input> -->
              <LeoInput v-if="schema.data[layoutName2].id == 'title'" v-model="formValues.title"
                :show-word-limit="schema.data[layoutName2].fields.showCounter"
                :max-length="schema.data[layoutName2].fields.maxLength"></LeoInput>
              <template v-else-if="schema.data[layoutName2].id == 'catProp'">
                <el-button type="primary" size="default" @click="autoSet">设置</el-button>
                <CatProp v-model="formValues.catProp" :catProp="schema.data.catProp"
                  v-if="init.catProp"></CatProp>
              </template>
              ...
              <template v-else-if="schema.data[layoutName2].type == 'cburadio'">
                <el-radio v-model="formValues[layoutName2].value" :key="key" :label="child.value"
              ...
              <template v-else-if="schema.data[layoutName2].type == 'cbu_unit'">
                <el-select v-model="formValues[layoutName2].unit" value-key="" placeholder=""
              ...
              <template v-else-if="schema.data[layoutName2].id == 'primaryPicture'">
                <primaryPicture v-model="formValues.primaryPicture" :product-id="$route.params.id">
                </primaryPicture>
              </template>
              ...
              <template v-else-if="schema.data[layoutName2].id == 'totalSales'">
                <el-input v-model="formValues[layoutName2]" placeholder="" size="normal"
                  clearable></el-input>
              </template>
              ...
              <template v-else-if="schema.data[layoutName2].id == 'mixBatch'">
                <el-checkbox v-model="formValues.mixBatchPre" @change="mixBatchPreChange">
                  <!-- {{ item.label }} -->
                </el-checkbox>
              ...
              <template v-else-if="schema.data[layoutName2].type == 'cbuselect'">
                <el-select v-model="formValues[layoutName2]" value-key="text" placeholder=""
                  clearable filterable>
              ...
              <template v-else-if="schema.data[layoutName2].id == 'weight'">
                <el-input style="width: 200px" v-model="formValues.weight" placeholder=""
              ...
              <template v-if="schema.data[layoutName2].id == 'description'">
                <Description1688 :product-id="$route.params.id" :product="product"
...
<script>
import { schema, initCatProp } from './index.js'
//  components
