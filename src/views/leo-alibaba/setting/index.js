  ...
  'data': {
    ...
    'productLine': {
      ...
      'fields': {
        ...
        'size': 'small',
        'promote': {
          'right': '<a target="_blank" href="https://channel.1688.com/page/offergroup.htm">管理产品线</a>'
        },
        'asyncCheck': false,
        'placeholder': '请选择产品线'
      },
    ...
    'seven_day': {
      ...
      'fields': {
        ...
        'size': 'medium',
        'promote': {
          'bottom': '<div class="warn">勾选此项，您的产品展示页面上将标明“本产品支持七天无理由退货”，您应履行服务承诺<br>     如不勾选，您的产品展示页面上将标明“本产品采购属于商业贸易行为”，可不适用“七天无理由退货” (交易双方另有约定的除外)</div>'
        },
        'asyncCheck': false,
        'dataSource': [
          {
    ...
    'blockLogistics': {
      ...
      'fields': {
        ...
        'uiType': 'cbublock',
        'promote': {
          'right': '<a href=\'https://56.1688.com/\' target=\'_blank\'>阿里巴巴推荐物流，运费低至8折！</a>'
        }
      },
      'position': 'body'
    },
    ...
    'invReduce': {
      ...
      'fields': {
        ...
        'size': 'medium',
        'promote': {
          'right': '部分场景库存扣减方式与产品设置无关，如：伙拼及疯狂店促固定为付款减库存'
        },
        'asyncCheck': false,
        'dataSource': [
          {
    ...
    'weight': {
      ...
      'fields': {
        ...
        'size': 'small',
        'promote': {
          'right': '运费模板将基于商品重量（含包装）统一计算运费，不同规格运费相同。如果是抛货，请用长*宽*高（cm³）/5000来换算重量。比如一个商品长宽高为50*70*80（cm³），则其重量=50*70*80/5000=56kg'
        },
        'asyncCheck': false,
        'precision': 4
      },
    ...
    'catNamer': {
      ...
      'fields': {
        ...
        'asyncCheck': false,
        'value': {
          'chooseCategoryUrl': 'https://offer.1688.com/offer/post/choose_category.htm',
          'pathList': [
            {
              'categoryId': 71,
              'name': '汽摩及配件'
    ...
    'iecProp': {
      ...
      'fields': {
        ...
        'promote': {
          ...
          'bottom': '<div class=\'warn\'>填写上栏产品认证证书编号，即为确认授权该证书出具机构等向阿里巴巴提供该证书对应的产品检测认证数据，包括公司名、证书号、地址、类型、检测标准、产品名称、规格参数、证书有效期等并加以展示（如为非自身产品，确认已获取产品方同意可作出前述授权确认），且可超链接自证书出具机构网站，便于用户查询确认。如无法确认，请勿填写</div>'
        },
        'asyncCheck': false
      },
      'position': 'body'
    ...
    'volume': {
      ...
      'fields': {
        ...
        'size': 'small',
        'promote': {
          'bottom': '加入海外一件代发后，针对抛货(如棉花)系统将按体积和重量数据，折算成体积重计算运费'
        },
        'asyncCheck': false,
        'value': {
          'height': null,
    ...
    'blockDescription': {
      ...
      'fields': {
        ...
        'uiType': 'cbublock',
        'promote': {
          'right': '<em>详情图片文案避免字体侵权</em><a href=\'/page/redirect.html?name=marketDetailDescNorm\' target=\'_blank\'>查看规范</a>'
        }
      },
      'position': 'body'
    },
    ...
    'deliveryTime': {
      ...
      'fields': {
        ...
        'size': 'small',
        'promote': {
          'right': '<span class="warn">现货类商品必须填写发货时间，如有买保发货服务的以买保为准</span>'
        },
        'asyncCheck': false,
        'dataSource': [
          {
    ...
    'title': {
      ...
      'fields': {
        ...
        'size': 'large',
        'promote': {
          'right': '<a href="/page/redirect.html?name=titleSuggestion">填写建议</a>'
        },
        'asyncCheck': true,
        'showCounter': true,
      ...
      'fields': {
        ...
        'dataSource': [
          ...
          },
          {
            ...
            'label': '种类',
            'async': {
              'childPropUrl': '/general/simpleAsyncRender.htm?optType=cbuRender&catId=1032176'
            },
            'required': true,
            'promote': {},
            'asyncCheck': false,
    ...
    'userCategory': {
      ...
      'fields': {
        ...
        'size': 'small',
        'promote': {
          'right': '<a target="_blank" href="https://apps.1688.com/page/userdefcatmanager.htm">管理自定义分类</a>'
        },
        'asyncCheck': false,
        'dataSource': [
          {
    ...
    'blockTrading': {
      ...
      'fields': {
        ...
        'info': {},
        'promote': {
          'right': '设置一件起批可能导致零售买家下单，为避免不必要的纠纷，请慎重操作。'
        },
        'asyncCheck': false
      },
      'position': 'body'
    ...
    'mixBatch': {
      ...
      'fields': {
        ...
        'size': 'medium',
        'promote': {
          'right': '<a target="_blank" href="https://marketing.1688.com/marketing/mixWholesaleSet.htm?flag=offerFlag&functionName=updateMixBatchSettings">混批规则详情</a>'
        },
        'asyncCheck': false,
        'dataSource': [
          {
