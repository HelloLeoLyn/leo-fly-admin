<template>
  <div class="block">
    <el-input v-model="subject" placeholder="请输入subject" :maxlength="128" :style="{width: '100%'}"
    ...
    <el-dialog :visible.sync="dialogVisible">
      <el-form>
        ...
        <el-form-item label="新标题">
          <el-input v-model="subject" type="textarea" placeholder="请输入subject" :maxlength="128"
