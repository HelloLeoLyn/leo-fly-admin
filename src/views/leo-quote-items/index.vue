<template>
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        <el-input v-model="queryForm.cid" placeholder="cid" style="width: 200px;"
          class="filter-item" />
        <el-input v-model="queryForm.pid" placeholder="pid" style="width: 200px;"
          class="filter-item" />
        ...
        <el-input v-model="queryForm.productName" placeholder="productName" style="width: 200px;"
          class="filter-item" />
        <el-input v-model="queryForm.quatity" placeholder="quatity" style="width: 200px;"
          class="filter-item" />
        <el-input v-model="queryForm.unitPrice" placeholder="unitPrice" style="width: 200px;"
          class="filter-item" />
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
      ...
      <el-table-column label="cid" prop="cid" align="center" />
      ...
      <el-table-column label="quatity" prop="quatity" align="center" />
      <el-table-column label="unitPrice" prop="unitPrice" align="center" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px"
        ...
        <el-form-item label="cid" prop="cid">
          <elinput v-model="temp.cid" />
        </el-form-item>
        <el-form-item label="pid" prop="pid">
          <elinput v-model="temp.pid" />
        </el-form-item>
        <el-form-item label="productId" prop="productId">
          <elinput v-model="temp.productId" />
        </el-form-item>
        <el-form-item label="productName" prop="productName">
          <elinput v-model="temp.productName" />
        </el-form-item>
        <el-form-item label="quatity" prop="quatity">
          <elinput v-model="temp.quatity" />
        </el-form-item>
        <el-form-item label="unitPrice" prop="unitPrice">
          <elinput v-model="temp.unitPrice" />
        </el-form-item>
        <el-form-item label="remark" prop="remark">
          <elinput v-model="temp.remark" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      total: 0,
      listLoading: true,
      queryForm: { remark: '', productName: '' },
      temp: { remark: '', productName: '' },
  ...
  methods: {
    doPage() {
      ...
      api_quote_items_page(this.queryForm).then((response) => {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          api_quote_items_post(this.temp).then(() => {
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          api_quote_items_put(this.temp).then(() => {
